...
contract SHIBSCTest is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA BSC TEST";
    string private _symbol = "SHIBSCTEST";
    ...
    uint256 public _maxTxAmount = 5 * 10 ** 3 * 10 ** 18;//5%
    uint256 private numTokensSellToAddToLiquidity = 2 * 10 ** 3 * 10 ** 18;//2%
